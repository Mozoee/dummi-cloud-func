 ...
 */
export declare function binary<T>(event: CloudEvent<T>): Message;
/**
 ...
 * @returns {Message} a Message object with headers and body
 */
export declare function structured<T>(event: CloudEvent<T>): Message;
/**
 ...
 */
export declare function deserialize<T>(message: Message): CloudEvent<T>;
